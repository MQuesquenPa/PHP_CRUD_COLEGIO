                    ...
                    ALUMNOS
                            ...
                            <form action="" method="post" >
                                ...
                                <div class="btn-group" role="group" aria-label="">
                                    <button onclick="insertarAlumno()" id="btnAgregar"  type="button" class="btn btn-success">Agregar</button>
                                    <button onclick="EditarAlumno()" id="btnEditar"  type="button" class="btn btn-warning disabled">Actualizar</button>
